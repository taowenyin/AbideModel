# download_abide_struc_civet_surfaces.py
#
...
Usage:
    python download_abide_struc_civet_surfaces.py -d <derivative> -p <pipeline>
...
# 数据下载程序
def collect_and_download(surfaces, pipeline, out_dir, less_than, greater_than, site, sex, diagnosis):
    """
...
if __name__ == '__main__':
    ...
    # 表面的类型，6个参数获取选取不定数量
    # ['gray_surface_rsl_left_81920', 'gray_surface_rsl_right_81920', 'mid_surface_rsl_left_81920', 'mid_surface_rsl_right_81920', 'white_surface_rsl_left_81920', 'white_surface_rsl_right_81920']
    desired_surface_list = ['gray_surface_rsl_left_81920']

    for desired_surface in desired_surface_list:
        # 构建保存地址
        output_data_dir = os.path.join(save_data_dir, desired_pipeline, 'surface', desired_surface)

        # 下载数据
        collect_and_download(desired_surface, desired_pipeline, output_data_dir, desired_age_max,

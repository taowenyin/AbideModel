# download_abide_struc_civet_region.py
#
...
Usage:
    python download_abide_struc_civet_region.py -d <derivative> -p <pipeline>
...
if __name__ == '__main__':
    ...
    # 表面的类型，6个参数获取选取不定数量
    # ['gi_left', 'gi_right', 'lobe_areas_40mm_left', 'lobe_areas_40mm_right',
    # 'lobe_native_cortex_area_left', 'lobe_native_cortex_area_right',
    # 'lobe_thickness_tlink_30mm_left', 'lobe_thickness_tlink_30mm_right',
    # 'lobe_volumes_40mm_left', 'lobe_volumes_40mm_right']
    desired_derivative_list = ['gi_left']

    for desired_derivative in desired_derivative_list:
        # 构建保存地址
        output_data_dir = os.path.join(save_data_dir, desired_pipeline, 'region', desired_derivative)
